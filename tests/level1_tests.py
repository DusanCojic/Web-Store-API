...
def run_level1_tests ( with_authentication, authentication_url, customer_url, with_blockchain, customer_private_key, owner_private_key, provider_url ):
    ...
    tests = [
        ...
        ["post", customer_url + "/order", set_up_order_test ( with_authentication, authentication_url, customer_url, with_blockchain, customer_private_key ), { }, get_order0 ( ), { }, 200, { }, evaluate_order_test ( with_blockchain, owner_private_key, provider_url ), 2],
        ...
        ["post", customer_url + "/order", set_up_order_test ( with_authentication, authentication_url, customer_url, with_blockchain, customer_private_key ), { }, get_order1 ( ), { }, 200, { }, evaluate_order_test ( with_blockchain, owner_private_key, provider_url ), 2],
